...
public class HomeSteps {
    ...
    public void checkNumberOfProductsInBasket(String numberOfProducts) {
        Assert.assertEquals("Number of products in basket is not correct, actuat: " + homePage.getNumberOfProductsFromBasket() + ", expected: " + numberOfProducts, homePage.getNumberOfProductsFromBasket(), numberOfProducts);
    }
}
